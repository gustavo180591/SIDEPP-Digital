...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
  {#if isLiquidador}
    ...
    <!-- Lista de instituciones para LIQUIDADOR con acceso a comprobantes -->
            ...
            {#each data.institutions as institution}
              <tr class="hover:bg-gray-50 transition-colors">
                <td class="px-6 py-4 whitespace-nowrap">
                  <a href="/dashboard/instituciones/{institution.id}/comprobantes" class="font-medium text-red-700 hover:text-red-900 hover:underline">
                    {institution.name}
                  </a>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right">
                  <a
                    href="/dashboard/instituciones/{institution.id}/comprobantes"
                    class="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-white bg-gradient-to-r from-red-700 to-red-600 rounded-lg hover:shadow-md transition-all"
                  >
