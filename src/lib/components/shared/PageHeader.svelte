...
<div class="bg-gradient-to-r from-white to-blue-50/50 rounded-xl p-6 mb-6 shadow-lg border border-blue-100">
  <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
    ...
    {#if showAction}
      <button
        class="px-5 py-3 text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center gap-2"
        on:click={onAction}
      >
