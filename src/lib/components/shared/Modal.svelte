      ...
      {:else}
        ...
        >
              ...
              <div class="form-control {field.span === 2 ? 'md:col-span-2' : ''}">
                ...
                {:else}
                  <input
                    ...
                    type={field.type}
                    name={field.name}
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 transition-colors {field.readonly ? 'border-gray-200 bg-gray-50 text-gray-500 cursor-not-allowed' : 'border-gray-300 bg-white text-gray-900 placeholder-gray-500 focus:ring-red-500 focus:border-red-500'}"
          ...
          <div class="flex justify-end gap-3 mt-6">
            ...
            <button
              class="px-5 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-red-700 to-red-600 rounded-lg hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-red-500 transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              type="submit"
              disabled={loading}
            >
              {#if loading}
